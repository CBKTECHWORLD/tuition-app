    ...
    <nav className="navbar">
      <div className="navbar-inner">
        <Link to="/" className="navbar-brand">
          <span className="brand-icon">◈</span><span>Krish Academy</span>
        </Link>
        <div className="navbar-links">
          {userRole === 'admin' && <>
            <Link className={`nav-link ${isActive('/admin')}`} to="/admin">Dashboard</Link>
            <Link className={`nav-link ${isActive('/admin/analytics')}`} to="/admin/analytics">Analytics</Link>
          ...
          {userRole === 'tutor' && <>
            <Link className={`nav-link ${isActive('/tutor')}`} to="/tutor">Dashboard</Link>
            ...
            <Link className={`nav-link ${isActive('/tutor/profile')}`} to="/tutor/profile">My Profile</Link>
          </>}
          {userRole === 'student' && <>
            <Link className={`nav-link ${isActive('/student')}`} to="/student">Find Tutors</Link>
